...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dir",
        help = "Directory for Training to be resumed."
    )
...
def load_last_epoch(custom_configs):
    ...
    signature = set(['classifier.pth', 'eval-records.csv', 'test-records.csv', 'train-records.csv'])
...
if __name__ == "__main__":
    try:
        ...
        classifier.load_state_dict(torch.load(
            Path.cwd() / custom_configs["output-path"] / f"Epoch {last_epoch}" / "classifier.pth",
